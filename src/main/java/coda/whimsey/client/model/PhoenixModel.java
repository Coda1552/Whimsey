...
public class PhoenixModel<T extends Phoenix> extends EntityModel<T> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition rightWing = root.addOrReplaceChild("rightWing", CubeListBuilder.create().texOffs(0, 25).mirror().addBox(0.0F, -6.0F, 1.0F, 0.0F, 9.0F, 18.0F, new CubeDeformation(0.0F)).mirror(false)
		.texOffs(22, 43).addBox(-1.0F, -4.0F, -1.0F, 2.0F, 7.0F, 14.0F, new CubeDeformation(0.0F)), PartPose.offset(-6.0F, -15.0F, -3.0F));

		PartDefinition leftWing = root.addOrReplaceChild("leftWing", CubeListBuilder.create().texOffs(0, 25).mirror().addBox(0.0F, -6.0F, 1.0F, 0.0F, 9.0F, 18.0F, new CubeDeformation(0.0F)).mirror(false)
		...
		PartDefinition head = root.addOrReplaceChild("head", CubeListBuilder.create().texOffs(0, 0).addBox(0.0F, -18.0F, 3.0F, 0.0F, 8.0F, 6.0F, new CubeDeformation(0.0F))
		...
		PartDefinition tail = root.addOrReplaceChild("tail", CubeListBuilder.create().texOffs(0, 16).addBox(-7.0F, 0.0F, 0.0F, 14.0F, 0.0F, 18.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -16.0F, 10.0F, -0.7854F, 0.0F, 0.0F));
